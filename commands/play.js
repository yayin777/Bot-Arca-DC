...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!SearchString)
      return client.sendTime(
        message.channel,
        `**Sonando - **\`${GuildDB.prefix}  [canción]\``
      );
    ...
    if (!CheckNode || !CheckNode.connected) {
      return client.sendTime(
        message.channel,
        "🚧 | **Esta madre se descompuso, hablenle al vato de las talachas :bolcan: **"
      );
    }
  ...
  SlashCommand: {
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      if (!CheckNode || !CheckNode.connected) {
        return client.sendTime(
          interaction,
          "☠ | **El fin del mundo! La caída del quinto sol! El fin del calendario! El regreso de Quetzalcoatl!**"
        );
      }
      ...
      if (search.match(client.Lavasfy.spotifyPattern)) {
        ...
        switch (Searched.loadType) {
          ...
          case "SEARCH_RESULT":
            ...
            SongAdded.setAuthor(`Añadido a la lista`, client.botconfig.IconURL);
